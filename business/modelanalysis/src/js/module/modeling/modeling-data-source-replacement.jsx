...
var FieldMapping = React.createClass({
    ...
    selectDSTreeItem: function(event, data) {
        ...
        if (!data.node.folder) {
            var dsLoader = loader($('#replacement-dialog-content .col-md-8'));
    ...
    render: function() {
        var fancytreeConfig = {
            ...
            activate: this.selectDSTreeItem
        };
        return (
            <div className="row mn">
            <div className="col-md-4 pt10 fancyTreeOver" style={{height: '499px', overflowY: 'auto'}}>
        ...
        rightBtnCallback: function() {
            ...
            if (_.size(state.columnMapping) == _.size(state.oldColumns)) {
                ...
                _.find(columnMapping, map => {
                    ...
                    if (!isTypeEqual(oldColumn.columnType,newColumn.columnType)) {

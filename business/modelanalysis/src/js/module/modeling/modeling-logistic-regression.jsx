...
var LGRegressionConditionComponent=React.createClass({
...
module.exports.render=function(container,data) {
    ...
    ReactDOM.render(
        <Provider.default><LGRegressionConditionComponent inputFields={inputFields}
                               selectedField={taskDetail.labelField}
                               positiveValue={taskDetail.positiveValue}
                               maxIterations={taskDetail.maxIterations}>
        </LGRegressionConditionComponent></Provider.default>, container)
};

...
(function($) {
    ...
    publicMethods = {
        pushTag : function (tag, ignoreEvents, externalTagId, aheadIconClass, IconClickEvent) {
            var $self = $(this), opts = $self.data('opts'), alreadyInList, tlisLowerCase, max, tagId,
            tlis = $self.data("tlis"), tlid = $self.data("tlid"), idx, newTagId, newTagRemoveId,newIconId, escaped,
            html, $el, lastTagObj;
            ...
            if (alreadyInList) {
                ...
                if(aheadIconClass){
                    newIconId = $self.data("tm_rndid") + '_Icon_' + tagId;
                    html += '<span class="tm-tag-icon '+aheadIconClass+'" id="' + newIconId + '" TagIdForIcon="'+tagId+'"> </span>';
                }
                ...
                if(IconClickEvent){
                    $el.find("#" + newIconId).on("click", $self, function(e) {
                        e.preventDefault();
                        var TagIdForIcon = parseInt($(this).attr("TagIdForIcon"));
                        IconClickEvent(TagIdForIcon);
                    });
                }

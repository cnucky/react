...
module.exports = function (req, res) {
	return {
			...
			"deleteTaskReport": function (args, callback) {
				if (_.isFunction(args)) {
					callback = args;
					args = {};
				}
				return jws(url, "deleteTaskReport", args, callback, req, res);
			},
			

			"destroyCache": function (args, callback) {
				if (_.isFunction(args)) {
					callback = args;
					args = {};
				}
				return jws(url, "destroyCache", args, callback, req, res);
			},
			...
			"getResultCodeTable": function (args, callback) {
				if (_.isFunction(args)) {
					callback = args;
					args = {};
				}
				return jws(url, "getResultCodeTable", args, callback, req, res);
			},
			

			"getResultData": function (args, callback) {
				if (_.isFunction(args)) {
					callback = args;
					args = {};
				}
				return jws(url, "getResultData", args, callback, req, res);
			},
			...
			"getResult_zzg": function (args, callback) {
				if (_.isFunction(args)) {
					callback = args;
					args = {};
				}
				return jws(url, "getResult_zzg", args, callback, req, res);
			},

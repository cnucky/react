define('widget/jqx-binding', ['udp-file-util', 'nova-notify', 'moment', 'utility/loaders', './tpl-result-demo', './tpl-result-demo-table'
     // '../../../../config',
    // '../lib/readcontrol/readJson',
    // '../lib/readcontrol/library',
    // '../lib/readcontrol/loadEmail',
    // '../lib/readcontrol/loadMms',
    // '../lib/readcontrol/loadHttp',
    // '../lib/readcontrol/loadOther',
    // '../lib/readcontrol/loadChat',
    // '../lib/readcontrol/loadAddr',
    // '../lib/readcontrol/loadAudio',
    // '../tpl/readcontrol/tpl_readEmail',
    // '../tpl/readcontrol/tpl_readMms',
    // '../tpl/readcontrol/tpl_readHttp',
    // '../tpl/readcontrol/tpl_readChat',
    // '../tpl/readcontrol/tpl_readOther',
    // '../tpl/readcontrol/tpl_readAddr',
    // '../tpl/readcontrol/tpl_readAudio'
    ],
    function(udpFileUtil, Notify, moment, loader, resultDemoTpl, resultDemoTableTpl
         // Config,
        // readJson,
        // lib,
        // loadEmail,
        ...
        function gridEvent(containerId) {
            ...
            $(document).on("click", '#viewType li a', function() {
                ...
                if (num == 2) {
                    ...
                    readJson.load_json_cont("/dataprocess/ProtocolAnalysis", params, function(url, data) {
        ...
        function getBoundata(event) {
            ...
            for (var item in bounddata) {
                if (item == "FILENAME" && bounddata[item] != "") flag = false;
            }
        ...
        function refreshWrapBox(data, bounddata) {
            ...
            if ($tableContainer) {
                ...
                var panelHeadingHtml = '<span class="pull-right fs12"><a href="javascript:void(0)" class="pre">上一条</a><a href="javascript:void(0)" class="next">下一条</a><a href="javascript:void(0)" class="close" title="关闭" style="opacity:0.8!important;margin-left:10px;margin-top:13px;"><span class="fa fa-times" id="close-span" style="color:#3498db;font-size: 18px"></span></a></span>' + '<ul class="nav panel-tabs-border panel-tabs panel-tabs-left" style="max-width: 302px;border-bottom:none;height:100%">' + '<li class="active"><a href="#tableContainer" data-toggle="tab" aria-expanded="false">结构化信息</a></li><li class="">' + '</li></ul>';//<a href="#tab1_1" data-toggle="tab" aria-expanded="true">主文件内容</a>
        ...
        var $wrapBox = $("#wrapBox");
        var params = []; //传入接口参数
        var serverIp = Config['attachServerIp'];
        ...
        function refreshContent(boundata) {
            ...
            $.each(params, function(i, val) {
                if (val.key.toUpperCase() == "FILENAME" && val.val != "") flag = false;
            });
            params.push({
                key: "contentEncode",
                val: ""

...
define(['jquery',
  //  'bootstrap',
   ...
   'utility/nanoscroller/jquery.nanoscroller',
   'utility/scroller/jquery.scroller',
   'utility/scrollLock/jquery-scrollLock',
   'underscore'
   ], function (jQuery) {
...
var Core = function(options) {
   ...
   // Variable Heights
   if (Navbar.is(':visible')) { navbarH = Navbar.outerHeight(); }
   if (Topbar.is(':visible')) { topbarH = Topbar.outerHeight(); }
   ...
   var runSideMenu = function(options) {
      ...
      // SideBar Left Toggle Function
        ...
        var sidebarLeftToggle = function() {
         ...
         if (Body.hasClass('sb-l-c') && options.collapse === "sb-l-m") {
            Body.removeClass('sb-l-c').addClass('sb-l-m');
         }
      ...
      $('#toggle_sidemenu_l').on('click', function(e) {
      ...
      var resizeBody = function() {
         ...
         Body.css('min-height', Math.min(cHeight, $(window).height()));
      };
   ...
   var runTrays = function() {
      ...
      if (trayFormat.length) {
         ...
         trayFormat.each(function(i,e) {
            ...
            This.outerHeight(contentHeight);

define('../module/md5-hash',
    function(){
        function ParseFile(file,hashmd5_callback) {

            var hash = new hashMe(file, function OutputHash(msg) {
                hashmd5_callback(msg);
            });
        ...
        var hashMe = function (file, callbackFunction) {
            ...
            this.calculateHashOfFile = function (file) {
                ...
                {
                    start = file.slice(0, 524288);
                    end = file.slice(file.size - 524288);
                }
                else
                {
                    start = file.slice(0, file.size / 2);
                    end = file.slice(file.size / 2);
                }


                //var end = file.slice(file.size - 524288, file.size);

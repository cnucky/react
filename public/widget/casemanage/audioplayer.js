define([
    ...
    */
    ...
    function controlsInit(height, autoplay) {
        ...
        tooltip($('.change-vol'), i18n.t("casemanage.audioplayer.bothvoice"));
        tooltip($('.change-right'),i18n.t("casemanage.audioplayer.secondvoice"));
        tooltip($('.change-left'), i18n.t("casemanage.audioplayer.firstvoice"));
        tooltip($('.volume-off'), i18n.t("casemanage.audioplayer.mute"));
        tooltip($('.volume-up'), i18n.t("casemanage.audioplayer.unmute"));
        tooltip($('.play'), i18n.t("casemanage.audioplayer.play"));
        tooltip($('.pause'), i18n.t("casemanage.audioplayer.pause"));
        tooltip($('.backward'), i18n.t("casemanage.audioplayer.backward"));
        tooltip($('.forward'), i18n.t("casemanage.audioplayer.forward"));
        tooltip($('.step-backward'), i18n.t("casemanage.audioplayer.nextitem"));
        tooltip($('.step-forward'), i18n.t("casemanage.audioplayer.lastitem"));
        tooltip($('.wave-hide'), i18n.t("casemanage.audioplayer.hidewave"));
        tooltip($('.wave-show'), i18n.t("casemanage.audioplayer.showwave"));

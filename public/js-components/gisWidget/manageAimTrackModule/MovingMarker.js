...
L.Marker.MovingMarker = L.Marker.extend({
    ...
    start: function() {
        ...
        if (this.isPaused()) {
            ...
            //自定义
            if(this._map.hasLayer(this.line)){
                this._map.removeLayer(this.line);
            }
            this.line=new L.polyline([this._latlngs[0]],{weight:2,color:this.options.color});
    ...
    _updateLine: function(timestamp) {
        ...
        while (elapsedTime > lineDuration) {
            ...
            if (stationDuration !== undefined) {
                //自定义
                this.fire('station',{index:lineIndex + 1});

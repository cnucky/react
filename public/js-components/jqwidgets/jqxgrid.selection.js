...
(function(a) {
    a.extend(a.jqx._jqxGrid.prototype, {
        selectallrows: function() {
            ...
            //edit by hjw
            if ((this.selectionmode == "checkbox"||this.selectionmode == "multiplerowscustomed") && !this._checkboxcolumnupdating) {
            ...
            //edit by hjw
            if (this.selectionmode == "checkbox" || this.selectionmode == "multiplerowscustomed") {
                this._raiseEvent(2, {
        ...
        _applyrowselection: function(e, i, f, h, b) {
            ...
            if (i) {
            	...
            	//edit by hjw
                if (d >= 0 || this.selectionmode == "singlerow" || this.selectionmode == "multiplerowsextended" || this.selectionmode == "multiplerowsadvanced" || this.selectionmode == "multiplerowscustomed") {
        ...
        _selectrowwithmouse: function(p, b, c, f, d, s) {
            ...
            //edit by hjw no need to add ,multiple...pattern has been included
        ...
        _handlemouseupselection: function(u, o) {
            ...
            //edit by hjw
            if (o.mousecaptured && (o.selectionmode == "multiplerowsextended" || o.selectionmode == "multiplerowsadvanced" || o.selectionmode == "multiplecellsextended" || o.selectionmode == "multiplecellsadvanced" || o.selectionmode == "multiplerowscustomed")) {
                o.mousecaptured = false;
                if (this.selectionarea.css("visibility") == "visible") {
                    this.selectionarea.css("visibility", "hidden");

	...
	jQuery.fn.multiselect.Constructor.prototype.selectAll = (function() {
		...
		return function() {
			var args			= Array.prototype.slice.call( arguments );
				args[0]			= (this.options.enableCollapsibleOptGroups) ? false : args[0];
	...
	jQuery.fn.multiselect.Constructor.prototype.createOptgroup = (function() {
		...
		return function() {
			...
			if (this.options.enableCollapsibleOptGroups) {
				...
				var r = e('<li class="multiselect-item multiselect-group"><a href="javascript:void(0);"><b> ' + n + '<b class="caret"></b></b></a></li>');
	...
	jQuery.fn.multiselect.Constructor.prototype.buildDropdownOptions = (function() {
		...
		return function() {
			...
			if (this.options.enableCollapsibleOptGroups) {
				...
				e("li.multiselect-group > a, li.multiselect-all > a > label.checkbox", this.$ul).css('padding', '3px 20px 3px 15px');

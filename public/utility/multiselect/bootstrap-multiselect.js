   ...
   Multiselect.prototype = {
      ...
      defaults: {
         ...
         buttonText: function(options, select) {
            ...
            //edit by huangjingwei,judge if(select[0].options) is undefined 
            else if (select[0].options!=undefined&& select[0].options.length === 1) {
               var selected = '';
      ...
      buildButton: function() {
            //add id by wangyan
         var id = this.$select.attr('id')?this.$select.attr('id')+'_sele':'';

         this.$button = $(this.options.templates.button).addClass(this.options.buttonClass).attr('id',id);;
      ...
      buildDropdown: function() {
           ...
           // add ul id by wangyan
         var id = this.$select.attr('id')?'ul_'+this.$select.attr('id')+'_sele':'';
         // Build ul.
         this.$ul = $(this.options.templates.ul).attr('id',id);

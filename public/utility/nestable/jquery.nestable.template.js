...
;(function($, window, document, undefined)
{
    ...
    Plugin.prototype = {
        ...
        dragStop: function(e)
        {
            ...
            this.reset();
            //判断如果是模板最后一个根 不显示删除 仅针对于#nestable_diy by zhang
            //if($("#nestable_diy")){
            //    if($("#nestable_diy ol.dd-list:first").children("li").length>1){
            //        $("#nestable_diy .dd3-content button.close").show();
            //    }else{
            //        $("#nestable_diy .dd3-content:eq(1) button.close").hide();
            //    }
            //}
        },
        ...
        dragMove: function(e)
        {
            ...
            if (mouse.dirAx && mouse.distAxX >= opt.threshold) {
                ...
                if (mouse.distX > 0 && prev.length && !prev.hasClass(opt.collapsedClass)) {
                    ...
                    if($("#nestable_diy")){
                        if(!this.placeEl.prev().children(".dd3-content").hasClass("diy")){//禁止水平拖入diy内
                            if(this.dragEl.find(".diy").length>0){//diy层或包含diy层到组可以水平多拖入一层
                                if (depth + this.dragDepth <= opt.maxDepth+1) {
                ...
                if (mouse.distX < 0) {
                    ...
                    if("#nestable_diy"){
                        if(this.placeEl.parents("ol.dd-list").index(".dd-list")>1){
                            if (!next.length) {
            ...
            if (!mouse.dirAx || isNewRoot || isEmpty) {
                ...
                if (isEmpty) {
                    ...
                    if($("#nestable_diy")){
                        if(this.pointEl.parents("ol.dd-list").index(".dd-list")==0){
                            return;
                        }else{
